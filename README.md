...
这是一个单人项目，你需要**独立完成**项目。我们提供了若干测试用例，你的代码需要能够通过测试用例。作为我们评分的标准，你需要提交**源代码**以及**实验报告**。
...
在这一部分，你需要阅读[Learning Rust With Entirely Too Many Linked Lists ](https://rust-unofficial.github.io/too-many-lists/) 。你可以参考[An Ok Unsafe Queue](https://rust-unofficial.github.io/too-many-lists/fifth.html)和[A Production Unsafe Deque](https://rust-unofficial.github.io/too-many-lists/sixth.html)来设计和实现你的链表。
